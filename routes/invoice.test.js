...
describe("GET /1", function () {
  ...
  test("Invoice info", async function () {
  ...
  test("Return 404 no invoice", async function () {
...
describe("PUT /", function () {
  ...
  test("Return 500 missing data", async function () {
    const response = await request(app)
        .put("/invoices/1")
        .send({});
...
describe("DELETE /", function () {
  ...
  test("Return 404 no invoices", async function () {
    const response = await request(app)
        .delete("/invoices/999");
